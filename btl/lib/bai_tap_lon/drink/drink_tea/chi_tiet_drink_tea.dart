...
class PageChiTietDrinkTea extends StatefulWidget {
  final DrinkTea drinkTea;
  PageChiTietDrinkTea({required this.drinkTea, Key? key}) : super(key: key);

  @override
  _PageChiTietCakeState createState() => _PageChiTietCakeState();
}

class _PageChiTietCakeState extends State<PageChiTietDrinkTea> {
  int _quantity = 1;
        ...
        child: Column(
          ...
          children: [
            Center(
              child: Container(
                width: w,
                child: Image.network(widget.drinkTea.anh ?? "No image"),
              ),
            ),
            SizedBox(height: 20),
            ...
            Padding(
              ...
              child: Text(widget.drinkTea.moTa ?? ""),
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                      ...
                      children: [
                        IconButton(
                          onPressed: () {
                            ...
                            controller.themvaoGHDrTea(widget.drinkTea, _quantity); // Navigate to the cart page
                          },
