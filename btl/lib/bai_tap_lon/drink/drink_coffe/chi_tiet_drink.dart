...
class PageChiTietDrink extends StatelessWidget {
  Drink dr;
  PageChiTietDrink({required this.dr, super.key});
          ...
          child: Column(
            ...
            children: [
              Center(
                child: Container(
                  width: w,
                  child: Image.network(dr.anh ?? "No image"),
                ),
              ),
              SizedBox(height: 20,),
              Column(
                ...
                children: [
                  Text(dr.ten,style: TextStyle(color: Colors.blue,fontSize: 30),),
                  Row(
                    children: [
                      Text("${dr.gia} vnđ",style: TextStyle(color: Colors.red,fontSize: 20),),
                      SizedBox(width: 10,),
                      Text("${dr.gia*1.8} vnđ",style: TextStyle(fontSize:20,decoration: TextDecoration.lineThrough),),
                    ],
                  ),
                  Text(dr.moTa!),
                  Row(
